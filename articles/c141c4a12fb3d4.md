...
Unicodeの日本語でややこしいのは漢字（異体字とか）ですが、その次にややこしいのはカタカナです。種類として全角・半角とあり、◯文字があり、歴史的経緯の物があります。今回は必要に迫られてカタカナをあさったので、それのメモ書きです。
...
3. ただし、カタカナと割り当てられてるけど使わない「・」等があることに注意
